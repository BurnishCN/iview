    ...
    <div :class="classes" @mousedown.prevent>
        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                ...
                <span
                    v-if="pickerTable === 'date-table' || pickerTable === 'week-table'"
                    :class="iconBtnCls('prev')"
                    @click="changeMonth(-1)"
                    v-show="currentView === 'date' || currentView === 'week'"><Icon type="ios-arrow-back"></Icon></span>
                <date-panel-label
                ...
                <span
                    ...
                    @click="changeMonth(+1)"
                    v-show="currentView === 'date' || currentView === 'week'"><Icon type="ios-arrow-forward"></Icon></span>
            </div>
...
export default {
    ...
    methods: {
        ...
        handlePreSelection(value) {
            ...
            if (
                this.pickerTable === "year-table" &&
                (this.selectionMode === "date" || this.selectionMode === "week")
            )
